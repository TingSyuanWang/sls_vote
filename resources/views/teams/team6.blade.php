...
@section('seo')
    <meta property="og:title" content="柬團第八梯：柬埔寨弱勢社區服務方案" />
    <meta property="og:image" content="{{asset('img/team6/logo.jpg')}}" />
    <meta property="og:url" content="{{route('team6')}}" />
    <meta property="og:description" content="「柬團第八梯：柬埔寨弱勢社區服務方案」延續前七梯次的服務能量，於偏鄉弱勢社區進行服務，透過海外跨文化服務，讓學生發揮潛能與學科訓練專長，建立國際視野與領導統籌能力，也持續強化與柬埔寨大專青年的協力合作模式，讓跨國青年學生彼此交流、相互學習、建立國際團隊合作與協調的能力。" />
@endsection
